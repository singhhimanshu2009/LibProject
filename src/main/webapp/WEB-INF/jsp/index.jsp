...
<!-- 	<style>
body {
  background-color: #4D4A49;   To add background color
}
</style> -->
...
<!-- <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
  Navbar content         too add navbar background color
</nav> -->
				...
				<form action="save" method="post">
					...
					<div class="form-group">
						<label for="bookName">Book Name:</label> <input type="text"
							class="form-control" value="${book.bookName}" name="bookName" id="bookName">
					</div>
					<div class="form-group">
						<label for="author">Author:</label> <input type="text"
							class="form-control" value="${book.author}" name="author" id="author">
					</div>
					<div class="form-group">
						<label for="date">Date:</label> <input type="date"
							class="form-control" value="${book.date}" name="date" id="date">
					</div>
